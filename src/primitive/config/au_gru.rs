use {
    ...
    crate::{
        ...
        primitive::{descriptor::PrimitiveDescriptor, AuGru, Direction, PropType},
    },
    onednnl_sys::{
        dnnl_augru_forward_primitive_desc_create, dnnl_primitive_attr_t, dnnl_rnn_direction_t,
        dnnl_status_t,
    },
...
impl<'a, D: Direction, P: PropType<D>> PrimitiveConfig<'a, D, P> for AuGruConfig<'a> {
